            ...
            <ContentWrapper className="grid">
                <ColCenteredDiv className="lg:col-6 col-12">
                    ...
                    <RowCenteredDiv className="mt-4 grid">
                        <button onClick={() => window.open("mailto:moramindravardhanreddy@gmail.com", "_self")}
                              className="cursor-pointer">
                            <Chip label=",moramindravardhanreddy@gmail.com" icon="pi pi-envelope"
                                  className="mr-2 mb-2 surface-card"/>
                        </button>
                        <Chip label="(+91) 9381362655" icon="pi pi-phone" className="mr-2 mb-2 surface-card"/>
                    </RowCenteredDiv>
